...
do {
  ...
  if (nombresCiudades !== null && nombresCiudades.trim() !== "") {
    arreglo = nombresCiudades
      .match(/['‘’""](.*?)['‘’""]/g)
      .map((ciudad) => ciudad.replace(/['‘’""]/g, "").trim());
    document.writeln(
      "El arreglo de ciudades tiene " + arreglo.length + " elementos"
    );
    document.writeln(`<ul>`);
    document.writeln("<li>Elemento 1er posición: " + arreglo[0] + " </li>");
    document.writeln("<li>Elemento 3er posición: " + arreglo[2] + " </li>");
    document.writeln(
      "<li>Elemento ultima posición: " + arreglo[arreglo.length - 1] + " </li>"
    );
    document.writeln("<br>");
